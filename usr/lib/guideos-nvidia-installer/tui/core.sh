...
# guideos-nvidia-installer - NVIDIA Driver Installer for Debian (TUI)
...
if [[ -n "$DEVENV" ]]; then
   export DIALOGRC="$(readlink -f "$(dirname "${BASH_SOURCE[0]}")/../../../../usr/share/guideos-nvidia-installer/theme.dialogrc")"
