...
tr::add "de_DE" "posinstall::install_cuda_toolkit.start" "CUDA Toolkit-Installation über das Repositorium %1 wird gestartet."
tr::add "de_DE" "posinstall::install_cuda_toolkit.confirm" "Sie sind dabei, das CUDA Toolkit zu installieren. Möchten Sie fortfahren?"
tr::add "de_DE" "posinstall::install_cuda_toolkit.update_failure" "CUDA Toolkit-Installation fehlgeschlagen: Paketliste konnte nicht aktualisiert werden."
tr::add "de_DE" "posinstall::install_cuda_toolkit.install_failure" "CUDA Toolkit-Installation fehlgeschlagen: Fehler bei der Paketinstallation."
tr::add "de_DE" "posinstall::install_cuda_toolkit.invalid_repo" "Unerwarteter Fehler: ungültiges Repositorium."
tr::add "de_DE" "posinstall::install_cuda_toolkit.success" "CUDA Toolkit-Installation erfolgreich abgeschlossen."
...
tr::add "de_DE" "posinstall::uninstall_cuda_toolkit.start" "CUDA Toolkit-Deinstallation über das Repositorium %1 wird gestartet."
tr::add "de_DE" "posinstall::uninstall_cuda_toolkit.confirm" "Sie sind dabei, das CUDA Toolkit zu deinstallieren. Möchten Sie fortfahren?"
tr::add "de_DE" "posinstall::uninstall_cuda_toolkit.uninstall_failure" "CUDA Toolkit-Deinstallation fehlgeschlagen: Fehler beim Entfernen der Pakete."
tr::add "de_DE" "posinstall::uninstall_cuda_toolkit.invalid_repo" "Unerwarteter Fehler: ungültiges Repositorium."
tr::add "de_DE" "posinstall::uninstall_cuda_toolkit.success" "CUDA Toolkit-Deinstallation erfolgreich abgeschlossen."
...
tr::add "de_DE" "posinstall::enable_nvidia_pvma.start" "PreserveVideoMemoryAllocation wird aktiviert..."
tr::add "de_DE" "posinstall::enable_nvidia_pvma.confirm" "Sie sind dabei, PreserveVideoMemoryAllocation zu aktivieren. Möchten Sie fortfahren?"
tr::add "de_DE" "posinstall::enable_nvidia_pvma.failure" "Fehler beim Aktivieren von PreserveVideoMemoryAllocation."
tr::add "de_DE" "posinstall::enable_nvidia_pvma.success" "PreserveVideoMemoryAllocation erfolgreich aktiviert."
...
tr::add "de_DE" "posinstall::disable_nvidia_pvma.start" "PreserveVideoMemoryAllocation wird deaktiviert..."
tr::add "de_DE" "posinstall::disable_nvidia_pvma.confirm" "Sie sind dabei, PreserveVideoMemoryAllocation zu deaktivieren. Möchten Sie fortfahren?"
tr::add "de_DE" "posinstall::disable_nvidia_pvma.failure" "Fehler beim Deaktivieren von PreserveVideoMemoryAllocation."
tr::add "de_DE" "posinstall::disable_nvidia_pvma.success" "PreserveVideoMemoryAllocation erfolgreich deaktiviert."
...
tr::add "de_DE" "posinstall::enable_nvidia_s0ixpm.start" "S0ix Power Management-Modus wird aktiviert..."
tr::add "de_DE" "posinstall::enable_nvidia_s0ixpm.confirm" "Sie sind dabei, den S0ix Power Management-Modus zu aktivieren. Möchten Sie fortfahren?"
tr::add "de_DE" "posinstall::enable_nvidia_s0ixpm.failure" "Fehler beim Aktivieren des S0ix Power Management-Modus."
tr::add "de_DE" "posinstall::enable_nvidia_s0ixpm.success" "S0ix Power Management-Modus erfolgreich aktiviert."
...
tr::add "de_DE" "posinstall::disable_nvidia_s0ixpm.start" "S0ix Power Management-Modus wird deaktiviert..."
tr::add "de_DE" "posinstall::disable_nvidia_s0ixpm.confirm" "Sie sind dabei, den S0ix Power Management-Modus zu deaktivieren. Möchten Sie fortfahren?"
tr::add "de_DE" "posinstall::disable_nvidia_s0ixpm.failure" "Fehler beim Deaktivieren des S0ix Power Management-Modus."
tr::add "de_DE" "posinstall::disable_nvidia_s0ixpm.success" "S0ix Power Management-Modus erfolgreich deaktiviert."
...
tr::add "de_DE" "posinstall::enable_power_service.start" "NVIDIA-Energiedienste werden aktiviert..."
tr::add "de_DE" "posinstall::enable_power_service.warning" "Aktivieren Sie die zusätzlichen NVIDIA-Energiedienste nur, wenn Sie Probleme mit dem Energiesparmodus (Suspend) oder Ruhezustand (Hibernate) haben. Diese Dienste sind standardmäßig nicht erforderlich und können das Systemverhalten beeinflussen."
tr::add "de_DE" "posinstall::enable_power_service.confirm" "Sie sind dabei, die NVIDIA-Energiedienste zu aktivieren. Möchten Sie fortfahren?"
tr::add "de_DE" "posinstall::enable_power_service.failure" "Fehler beim Aktivieren des Dienstes: %1"
tr::add "de_DE" "posinstall::enable_power_service.success" "NVIDIA-Energiedienste erfolgreich aktiviert."
...
tr::add "de_DE" "posinstall::disable_power_service.start" "NVIDIA-Energiedienste werden deaktiviert..."
tr::add "de_DE" "posinstall::disable_power_service.confirm" "Sie sind dabei, die NVIDIA-Energiedienste zu deaktivieren. Möchten Sie fortfahren?"
tr::add "de_DE" "posinstall::disable_power_service.failure" "Fehler beim Deaktivieren des Dienstes: %1"
tr::add "de_DE" "posinstall::disable_power_service.success" "NVIDIA-Energiedienste erfolgreich deaktiviert."
